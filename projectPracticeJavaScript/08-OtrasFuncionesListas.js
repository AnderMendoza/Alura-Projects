...
console.log(`En la lista de pasises tenemos: ${paisesDisponibles.length} elementos`);
...
// Unificar los elemmentos en una cadena de caracteres
console.log(paisesDisponibles.join(' - '));

// Ordenar la lista
console.log(paisesDisponibles.sort());

// Conociemdo la posicion
...
console.log(`Lista de paises y ciudaddes:`);
